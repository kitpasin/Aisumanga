...
import { completed_manga } from "@/data/completed_manga";
...
function CompletedManga() {
  ...
  const filteredManga = completed_manga.filter((manga) => {
  ...
  return (
    <main className="w-full min-h-[calc(100vh-452px)] max-w-[1280px] m-auto mt-4 flex flex-col-reverse xl:flex-row justify-between items-center xl:items-start xl:px-4 gap-4">
      ...
      <div className="w-full max-w-[768px] lg:max-w-[980px] px-4 xl:px-0 xl:max-w-[460px] h-ful flex gap-4 xl:gap-0 flex-col xs:flex-row xl:flex-col">
        <MangaStatus />
        <MangaGenre />
      </div>
    </main>
